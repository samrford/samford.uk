  ...
  return (
    <section className="flex flex-col items-start gap-6 pt-20 sm:pt-28">
      ...
      <p className="max-w-prose text-lg leading-relaxed text-muted-foreground sm:text-xl">
        ...
        I love to travel, check out some of my trip reports and upcoming adventures on my app, <a href="https://beyond-travel.net/u/sam" className="text-foreground hover:underline" target="_blank" rel="noopener noreferrer">Beyond!</a> <br /><br />
