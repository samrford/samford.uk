  ...
  return (
    <section className="flex flex-col items-start gap-6 pt-20 sm:pt-28">
      ...
      <p className="max-w-prose text-lg leading-relaxed text-muted-foreground sm:text-xl">
        ...
        I work at <a href="https://markup.ai" className="text-foreground hover:underline" target="_blank" rel="noopener noreferrer">Markup AI</a>. <br />
        Below are a list of things I've built, or am currently working on!
      </p>
      <Socials />
    </section>
  )
